...
- rationale: **2~4문장** 으로 이 일정을 이렇게 설계한 근거를 서술.
  ...
  2) **사용자 자유 요청 중 달성 못한 부분이 있으면** 해당 항목과 이유를 반드시 포함. 달성 못한 게 없으면 (2) 생략.
     - **예산**: 사용자가 예산을 명시했고 일정 전체 예상 경비 (숙박·렌트카 포함, budget.extras + 각 item 의 cost_krw 합) 가 그 예산을 초과하면, rationale 에 "요청 예산 X만원 · 예상 Y만원 (Z만원 초과)" 숫자 명시 + 주원인 + 대안 제시 필수. "숙박비 별도", "식비 기준" 같이 뭉개는 표현 금지.
